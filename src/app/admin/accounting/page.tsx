...
export default async function AccountingDashboardPage() {
  ...
  if (!session || (!['ADMIN', 'MANAGER', 'ACCOUNTANT', 'MILL_OWNER', 'SUPER_ADMIN'].includes(session.user?.role || ''))) {
    redirect('/dashboard');
  }
  ...
  // Fetch recent transactions (increased to 300 to ensure monthly notebook has data)
  ...
  return (
    <div className="min-h-screen">
      <AppHeader title="Cashbook & Accounts" subtitle="Financial overview and operations" breadcrumbs={[{label: 'Dashboard', href: '/dashboard'}, {label: 'Accounting'}]} />
